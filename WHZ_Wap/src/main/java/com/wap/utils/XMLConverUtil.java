...
public class XMLConverUtil {
	 ...
	 * @return
	 */
	public static synchronized <T> T convertToObject(Class<T> clazz, String xml) {
	 ...
	 * @return
	 */
	public static synchronized <T> T convertToObject(Class<T> clazz, InputStream inputStream) {
